...
class HMuTauhTreeFromNano : public HTauTauTreeFromNanoBase {
 public :
  ...
  HMuTauhTreeFromNano(TTree *tree=0, bool doSvFit=false, bool correctRecoil=false, std::vector<edm::LuminosityBlockRange> lumiBlocks = std::vector<edm::LuminosityBlockRange>(), std::string prefix="HTTMT");
...
HMuTauhTreeFromNano::HMuTauhTreeFromNano(TTree *tree, bool doSvFit, bool correctRecoil, std::vector<edm::LuminosityBlockRange> lumiBlocks, std::string prefix) : HTauTauTreeFromNanoBase(tree, doSvFit, correctRecoil, lumiBlocks, prefix)
{}
