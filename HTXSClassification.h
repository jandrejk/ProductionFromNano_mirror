...
//     ~HTXSClassification(){}
    ...
    Stage1::Category getStage1Category(HiggsProdMode prodMode, const TLorentzVector &higgs, HTTJetCollection *jets);
 // namespace Stage1
// };
#endif
